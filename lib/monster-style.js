...
function buildHalloweenStoryImagePrompt(sceneDescription = "") {
  return buildStoryScenePrompt(
    [
      "Halloween story image with cozy autumn colors, pumpkins, gentle porch lights, friendly costumes, and a playful seasonal mood.",
      "Keep the scene cute, bright enough for young children, and never scary or creepy.",
      sceneDescription,
    ]
      .filter(Boolean)
      .join(" "),
...
module.exports = {
  ...
  buildHalloweenStoryImagePrompt,
